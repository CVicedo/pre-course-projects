...
//Orders players ranking so it can be shown properly in a further function (const player)
function compare(a, b) {
    // Use toUpperCase() to ignore character casing
    const playerA = a.player.toUpperCase();
    const playerB = b.player.toUpperCase();
...
//Checks if there is a winner line. NEEDS SOME CHANGES
